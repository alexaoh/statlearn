...
```{r}
# Backward selection.
regfit.bwd <- regsubsets(Balance~., data = credit_data_training, nvmax = n, method = "forward")
...
```{r}
# Hybrid selection.
regfit.h <- regsubsets(Balance~., data = credit_data_training, nvmax = n, method = "forward")
